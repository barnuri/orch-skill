// Validation rules shared by the profiles/memory validators. Enums (harness and
...
export const ROOT_KEYS = ["settings", "profiles"] as const;
export const SETTINGS_KEYS = ["default_profile", "retention_days", "budget_threshold"] as const;
export const PROFILE_KEYS = ["harness", "model", "flags", "env", "auth"] as const;
